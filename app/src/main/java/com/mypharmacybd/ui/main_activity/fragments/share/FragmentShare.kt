package com.mypharmacybd.ui.main_activity.fragments.share
...
import com.mypharmacybd.databinding.FragmentShareBinding
...
class FragmentShare : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // set title
        binding.topBar.tvTitle.text = getString(R.string.share)
